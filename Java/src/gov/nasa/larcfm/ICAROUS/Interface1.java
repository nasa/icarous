...
public class Interface1{
	...
	public Interface1(int intType,String hostname,int recvPort,int sendPort,AircraftData acData){
	...
	public Interface1(int intType,String portName,int BAUDRATE,AircraftData acData){
	...
	public static void PassThroughMAVPackets(Interface1 AP, Interface1 GS){
	...
	public static void PassThrough(Interface1 AP, Interface1 GS){
		byte[] AP_buffer = null;
		byte[] GS_buffer = null;
