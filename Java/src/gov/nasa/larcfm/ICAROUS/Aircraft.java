...
public class Aircraft implements ErrorReporter {
    ...
    public int SendCommand(int target_system, int target_component, int command, int confirmation, float param1,
            float param2, float param3, float param4, float param5, float param6, float param7, boolean CheckACK) {
    ...
    public void SetYaw(double heading) {
        ...
        SendCommand(0, 0, MAV_CMD.MAV_CMD_CONDITION_YAW, 0, (float) heading, 0, 1, 0, 0, 0, 0, false);
    ...
    public int CheckAcknowledgement(int command) {
        ...
        while (msgCommandAck == null) {
            ...
            if (msgCommandAck != null) {
                // System.out.format("Got ack for %d =
    ...
    public void SetSpeed(float speed) {
        ...
        SendCommand(0, 0, MAV_CMD.MAV_CMD_DO_CHANGE_SPEED, 0, 1, speed, 0, 0, 0, 0, 0, false);
    ...
    public int Flight() {
        ...
        switch (state) {
            ...
            case TAKEOFF:
                ...
                ack = SendCommand(0, 0, MAV_CMD.MAV_CMD_COMPONENT_ARM_DISARM, 0, 1, 0, 0, 0, 0, 0, 0, true);
                ...
                ack = SendCommand(0, 0, MAV_CMD.MAV_CMD_NAV_TAKEOFF, 0, 1, 0, 0, 0, (float) currPosition.latitude(),
                        (float) currPosition.longitude(), targetAlt, true);
            ...
            case TAKEOFF_CLIMB:
                ...
                // Switch to auto once targetAlt [m] is reached and start mission in
                // auto mode
            ...
            case LAND:
                ...
                if (!landStart) {
                    ...
                    SendCommand(0, 0, MAV_CMD.MAV_CMD_NAV_LAND, 0, 6.0f, 0, 0, 0, (float) currPosition.latitude(),
                            (float) currPosition.longitude(), (float) currPosition.alt(), false);
