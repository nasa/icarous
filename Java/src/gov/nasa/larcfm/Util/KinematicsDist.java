...
public class KinematicsDist {
	...
	// experimental: return time needed to accel from gs1 to gs2 over given distance
	public static double gsConstantAccelTimeFromDist(double gs1, double gs2, double dist) {
		return 2*dist/(gs1+gs2);
	}
