...
//  }
   ...
   */
  public static String fmt(double[] data, String unit, int width, int precision) {
  ...
  public static String fmt(double[][] data, String unit, int width, int precision) {
	  ...
	  for (int i = 0; i < data.length; i++) {
		  ...
		  sb.append(fmt(data[i],unit,width,precision));
		  if (i == data.length-1) {
			  sb.append("]");
		  } else {
			  sb.append("\n");
  ...
  public static String fmt(double[][][] data, String unit, int width, int precision) {
	  ...
	  for (int i = 0; i < data.length; i++) {
		  for (int j = 0; j < data[i].length; j++) {
			  ...
			  sb.append(fmt(data[i][j],unit,width,precision));
