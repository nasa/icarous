/* 
 * Conflict Bands (two time version)
 *
 ...
 */
public final class ConflictBandsTwoTimes implements GenericDHStateBands {   
  ...
  private ErrorLog error = new ErrorLog("ConflictBandsTwoTimes");
   ...
   */
  public ConflictBandsTwoTimes(double D, String dunit, double H, String hunit, double Tnear, double Tmid, String tunit, double max_gs, String gsunit, double max_vs, String vsunit) {
...
//  }
  ...
  private void trackCompute() {
    ...
    int len = trk_amber.size()+trk_red.size();
    trackArray = new ArrayList<Interval>(len);
    trackRegionArray = new ArrayList<BandsRegion>(len);

    toArrays(trackArray, trackRegionArray, trk_red, trk_amber);
  }
  ...
  private void groundCompute() {
    ...
    int len = gs_amber.size()+gs_red.size();
    groundArray = new ArrayList<Interval>(len);
    groundRegionArray = new ArrayList<BandsRegion>(len);

    toArrays(groundArray, groundRegionArray, gs_red, gs_amber);
  }
