...
public final class DaidalusParameters implements ParameterAcceptor, ErrorReporter {
   ...
   * DAIDALUS version
   */
  public static final String VERSION = "j-0.99m-Aug-16-2016";

  /**
   * Default parameter values
   */
  public static final DaidalusParameters DefaultValues = new DaidalusParameters();
  ...
  public void setParameters(ParameterData p) {
    ...
    if (p.contains("ca_factor")) ca_factor_ = p.getValue("ca_factor");
    // Contours
