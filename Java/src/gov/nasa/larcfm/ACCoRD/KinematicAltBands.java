...
public class KinematicAltBands extends KinematicRealBands {
  ...
  public KinematicAltBands() {
    super(DaidalusParameters.DefaultValues.getMinAltitude(),
        DaidalusParameters.DefaultValues.getMaxAltitude(),
        DaidalusParameters.DefaultValues.getAltitudeStep(),
        DaidalusParameters.DefaultValues.isEnabledRecoveryAltitudeBands());
    vertical_rate_ = DaidalusParameters.DefaultValues.getVerticalRate();
