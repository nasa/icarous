...
public class DAAGeofencingExample{
	public static void main(String args[]) {
		...
		System.out.println("##");
		System.out.println("## "+Icarous.release());
		System.out.println("## DAA Provided by DAIDALUS");
		System.out.println("## Geofencing Provided by PolyCARP");
		System.out.println("##\n");
		...
		String conf_file = "params/DaidalusQuadConfig.txt";
		if (!daa.parameters.loadFromFile(conf_file)) {
			System.out.println("File "+conf_file+" not found");
			System.exit(0);
		} else {
			System.out.println("Loading DAA confiuration file "+conf_file);
		}
