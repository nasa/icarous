...
public class PolycarpQuadMinmax {

	public static double quadratic(double a,double b,double c,double x) {
	    return a*x*x+b*x+c;
	}

	public static double quad_min_int(double a,double b,double c,double xl,double xu) {
	...
	public static boolean quad_min_le_D_int(double ap,double b,double c,double xl,double xu,double D) {
