 ...
 * Kinematic Bands
 *
 * Contact: Cesar Munoz, George Hagen, Jeff Maddalon, and Rick Butler
...
public class KinematicBands implements GenericStateBands {
  ...
  private KinematicTrkBands  trk_band_; 
  private KinematicGsBands   gs_band_;  
  private KinematicVsBands   vs_band_;  
  private KinematicAltBands  alt_band_; 
  private KinematicBandsCore core_;
  ...
  public KinematicBands(Detection3D detector) {
    core_ = new KinematicBandsCore(detector);
  ...
  /*
   * Accessor to internal trk_band. EXPERT USE ONLY
   */
  ...
  /*
   * Accessor to internal gs_band. EXPERT USE ONLY
   */
  ...
  /*
   * Accessor to internal vs_band. EXPERT USE ONLY
   */
  ...
  /*
   * Accessor to internal alt_band. EXPERT USE ONLY
   */
  ...
  /*
   * Accessor to internal core. EXPERT USE ONLY
   */
  ...
  public void setParameters(DaidalusParameters parameters) {
    core_.alerting_time = parameters.getAlertingTime();
    core_.lookahead_time = parameters.getLookaheadTime();
    ...
    gs_band_.setHorizontalAcceleration(parameters.getHorizontalAcceleration()); 
    setVerticalAcceleration(parameters.getVerticalAcceleration()); 
    trk_band_.setTurnRate(parameters.getTurnRate()); 
    trk_band_.setBankAngle(parameters.getBankAngle()); 
    alt_band_.setVerticalRate(parameters.getVerticalRate()); 
    core_.recovery_stability_time = parameters.getRecoveryStabilityTime(); 
    core_.max_recovery_time = parameters.getMaxRecoveryTime();
    core_.min_horizontal_recovery = parameters.getMinHorizontalRecovery();
    core_.min_vertical_recovery = parameters.getMinVerticalRecovery();
    core_.ca_bands = parameters.isEnabledCollisionAvoidanceBands();
    core_.conflict_crit = parameters.isEnabledConflictCriteria();
    core_.recovery_crit = parameters.isEnabledRecoveryCriteria();
  ...
  /**
   * @return lookahead time in specified units [u]. This is the time horizon used to compute bands.
   */
  ...
  public void setLookaheadTime(double t) {
    if (error.isPositive("setLookaheadTime",t) && t != core_.lookahead_time) {
  ...
  /** 
   * Sets lookahead time in specified units [u]. This is the time horizon used to compute bands.
   */ 
  ...
  public void setAlertingTime(double t) {
    if (error.isNonNegative("setAlertingTime",t) && t != core_.alerting_time) {
      core_.alerting_time = t;
      reset();
    }
  }
  ...
  public double getMaxRecoveryTime() {
    return core_.max_recovery_time;
  }
  ...
  public void setMaxRecoveryTime(double t) {
    if (error.isNonNegative("setMaxRecoveryTime",t) && t != core_.max_recovery_time) {
      core_.max_recovery_time = t;
      reset();
    }
  }
  ...
  /**
   * Set most urgent aircraft according to urgency strategy
   */
  public void setMostUrgentAircraft(UrgencyStrategy strat) {
    TrafficState ac = TrafficState.INVALID;
    if (core_.hasOwnship() && core_.hasTraffic()) {
      ac = strat.mostUrgentAircraft(core_.detector,core_.ownship,
          core_.traffic,core_.alertingTime());
    }
    setMostUrgentAircraft(ac);
  }
  ...
  public double getHorizontalAcceleration() {
    return gs_band_.getHorizontalAcceleration();
  }
  ...
  public void setHorizontalAcceleration(double val) {
    if (error.isNonNegative("setHorizontalAcceleration",val)) {
      gs_band_.setHorizontalAcceleration(val);
    }
  }
  ...
  public double getVerticalAcceleration() {
    return vs_band_.getVerticalAcceleration();
  }
  ...
  public void setVerticalAcceleration(double val) {
    if (error.isNonNegative("setVerticalAcceleration",val)) {
      vs_band_.setVerticalAcceleration(val);
      alt_band_.setVerticalAcceleration(val);
    }
  }
  ...
  public double getVerticalRate() {
    return alt_band_.getVerticalRate();
  }
  ...
  /**
   *  Returns list of aircraft responsible for corrective bands
   */
  public List<TrafficState> correctiveBandsAircraft() {
    return core_.correctiveAircraft();
  }

  /**
   *  Returns time interval, in seconds, to first and last violations responsible for corrective 
   *  bands. Returns the empty interval [infty,-infty] if there are no corrective bands.
   */
  public Interval timeIntervalOfCorrectiveBands() {
    return core_.timeIntervalOfCorrectiveBands();
  }
  ...
  /**
   * @return the band index of a given track specified in internal units [rad]
   * @param trk [rad]
   */
  public int trackBand(double trk) {
    return trk_band_.band(core_,trk);
  }

  /**
   * @return the band index of a given track specified in given units [u]
   * @param trk [u]
   * @param u Units
   */
  public int trackBand(double trk, String u) {
    return trackBand(Units.from(u, trk));
  }
  ...
  public BandsRegion regionOfTrack(double trk) {
    return trackRegion(trackBand(trk));
  }
  ...
  public BandsRegion regionOfTrack(double trk, String u) {
    return trackRegion(trackBand(trk,u));
  }
  ...
  /**
   * @return list of aircraft responsible for preventive track bands 
   */
  public List<TrafficState> preventiveTrackBandsAircraft() {
    return trk_band_.preventiveAircraft(core_);
  }
  ...
  /**
   * @return the band index of a given ground speed specified in internal units [m/s]
   * @param gs [m/s]
   */
  public int groundSpeedBand(double gs) {
    return gs_band_.band(core_,gs);
  }

  /**
   * @return the band index of a given ground speed specified in given units [u]
   * @param gs [u]
   * @param u Units
   */
  public int groundSpeedBand(double gs, String u) {
    return groundSpeedBand(Units.from(u,gs));
  }
  ...
  public BandsRegion regionOfGroundSpeed(double gs) {
    return groundSpeedRegion(groundSpeedBand(gs));
  }
  ...
  public BandsRegion regionOfGroundSpeed(double gs, String u) {
    return groundSpeedRegion(groundSpeedBand(gs,u));
  }
  ...
  /**
   * @return list of aircraft responsible for preventive ground speed bands 
   */
  public List<TrafficState> preventiveGroundSpeedBandsAircraft() {
    return gs_band_.preventiveAircraft(core_);
  }
   ...
   * @param vs [m/s]
   */
  public int verticalSpeedBand(double vs) {
    return vs_band_.band(core_,vs);
  }
   ...
   * @param u Units
   */
  public int verticalSpeedBand(double vs, String u) {
    return verticalSpeedBand(Units.from(u, vs));
  }
  ...
  public BandsRegion regionOfVerticalSpeed(double vs) {
    return verticalSpeedRegion(verticalSpeedBand(vs));
  }
  ...
  public BandsRegion regionOfVerticalSpeed(double vs, String u) {
    return verticalSpeedRegion(verticalSpeedBand(vs,u));
  }
  ...
  /**
   * @return list of aircraft responsible for preventive vertical speed bands 
   */
  public List<TrafficState> preventiveVerticalSpeedBandsAircraft() {
    return vs_band_.preventiveAircraft(core_);
  }
  ...
  /**
   * @return the band index of a given altitude specified internal units [m]
   * @param alt [m]
   */
  public int altitudeBand(double alt) {
    return alt_band_.band(core_,alt);
  }

  /**
   * @return the band index of a given altitude specified in given units [u]
   * @param alt [u]
   * @param u Units
   */
  public int altitudeBand(double alt, String u) {
    return altitudeBand(Units.from(u,alt));
  }
  ...
  public BandsRegion regionOfAltitude(double alt) {
    return altitudeRegion(altitudeBand(alt));
  }
  ...
  public BandsRegion regionOfAltitude(double alt, String u) {
    return altitudeRegion(altitudeBand(alt,u));
  }
  ...
  /**
   * @return list of aircraft responsible for preventive altitude bands 
   */
  public List<TrafficState> preventiveAltitudeBandsAircraft() {
    return alt_band_.preventiveAircraft(core_);
  }
  ...
  public double altitudeResolution(boolean dir) {
    if (core_.timeIntervalOfCorrectiveBands().isEmpty()) {
      return Double.NaN;
    } else {
  ...
  public void setCoreDetection(Detection3D det) {
    core_.detector = det.copy(); //if we do not make copies, this will not be thread-safe!
    reset();
  }
  ...
  public String toString() {
    ...
    String s = "";
    s+=core_.detector.toString()+"\n";
    s+="# Default Parameters (Bands)\n";
    s+="alerting_time = "+DaidalusParameters.val_unit(core_.alerting_time,"s")+
        " ("+f.Fm4(core_.alertingTime())+" [s])\n";
    ...
    s+="turn_rate = "+DaidalusParameters.val_unit(trk_band_.getTurnRate(),"deg/s")+"\n";
    s+="bank_angle = "+DaidalusParameters.val_unit(trk_band_.getBankAngle(),"deg")+"\n";
    s+="vertical_rate = "+DaidalusParameters.val_unit(alt_band_.getVerticalRate(),"fpm")+"\n";
    s+="# Default Parameters (Recovery Bands)\n";
    s+="recovery_stability_time = "+DaidalusParameters.val_unit(getRecoveryStabilityTime(),"s")+"\n";
    s+="max_recovery_time = "+DaidalusParameters.val_unit(core_.max_recovery_time,"s")+
        " ("+f.Fm4(core_.maxRecoveryTime())+" [s])\n";
  ...
  public String outputString() {
    ...
    s+="Aircraft Contributing to Corrective Bands: "+
        TrafficState.listToString(correctiveBandsAircraft())+"\n";
    s+="Time Interval of Corrective Bands: "+timeIntervalOfCorrectiveBands().toString(2)+" [s]\n";
    ...
    s+="Aircraft Contributing to Preventive Track Bands: "+
        TrafficState.listToString(preventiveTrackBandsAircraft())+"\n";
    ...
    s+="Aircraft Contributing to Preventive Ground Speed Bands: "+
        TrafficState.listToString(preventiveGroundSpeedBandsAircraft())+"\n";
    ...
    s+="Aircraft Contributing to Preventive Vertical Speed Bands: "+
        TrafficState.listToString(preventiveVerticalSpeedBandsAircraft())+"\n";
    ...
    s+="Aircraft Contributing to Preventive Altitude Bands: "+
        TrafficState.listToString(preventiveAltitudeBandsAircraft())+"\n";
