...
if [ "$1" == 'SITL' ];then
   ...
   java -cp bin:lib/jssc-2.8.0.jar:lib/FormalATMj/FormalATM.jar launch -v --sitl 14551 --com localhost 14552 14550

elif [ "$1" == 'PX4' ];then
    echo "Launching ICAROUS for Pixhawk"
    java -cp bin:lib/jssc-2.8.0.jar:lib/FormalATMj/FormalATM.jar launch -v --px4 /dev/ttyO1 --com localhost 14552 14550 --bc 230.1.1.1 5555
elif [ "$1" == 'GS' ];then
    echo "Launching Ground station test"
    java -cp bin:lib/jssc-2.8.0.jar:lib/FormalATMj/FormalATM.jar GStest -v --sitl 14551 --com 14552 --bc 230.1.1.1 5555
