...
Resolution_t::Resolution_t(QuadFMS_t* fms){
	...
	DAA.parameters.loadFromFile("ram/DaidalusQuadConfig.txt");
...
void Resolution_t::ResolveFlightPlanDeviation(){
	...
	xtrkDevGain     = FlightData->paramData->xtrkGain;
	resolutionSpeed = FlightData->paramData->resolutionSpeed;
	allowedDev      = FlightData->paramData->xtrkDev;
...
void Resolution_t::ResolveKeepOutConflict_Astar(){
	...
	double gridsize          = FlightData->paramData->gridSize;
	double buffer            = FlightData->paramData->buffer;
	double lookahead         = FlightData->paramData->lookahead;
	double resolutionSpeed   = FlightData->paramData->resolutionSpeed;
	double maxAlt            = FlightData->paramData->maxCeiling;
	double Hthreshold        = FlightData->paramData->hThreshold;
...
void Resolution_t::ResolveTrafficConflictDAA(){
	...
	int gotoNextWP = FlightData->paramData->gotoNextWP;
...
void Resolution_t::ResolveTrafficConflictRRT(){
	...
	double maxInputNorm = FlightData->paramData->resolutionSpeed;
