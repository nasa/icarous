...
// DDS MAVLink::GPSInfo TypeSupportMetaHolder Object Body
MAVLink::GPSInfoTypeSupportMetaHolder::GPSInfoTypeSupportMetaHolder () :
        DDS::OpenSplice::TypeSupportMetaHolder ("MAVLink::GPSInfo", "", "")
{
    copyIn = (DDS::OpenSplice::cxxCopyIn) __MAVLink_GPSInfo__copyIn;
    copyOut = (DDS::OpenSplice::cxxCopyOut) __MAVLink_GPSInfo__copyOut;
    metaDescriptorArrLength = 5;
    metaDescriptorLength = 475;
    const char *tmp[] = {"<MetaData version=\"1.0.0\"><Module name=\"MAVLink\"><Struct name=\"GPSInfo\"><Member name=\"time\"><Double/>",
"</Member><Member name=\"latitude\"><Double/></Member><Member name=\"longitude\"><Double/></Member><Member name=\"absoluteAltitude\">",
"<Double/></Member><Member name=\"relativeAltitude\"><Double/></Member><Member name=\"xVelocity\"><Double/>",
"</Member><Member name=\"yVelocity\"><Double/></Member><Member name=\"zVelocity\"><Double/></Member></Struct>",
"</Module></MetaData>"};
...
MAVLink::GPSInfoTypeSupportMetaHolder::create_datawriter ()
{
    return new MAVLink::GPSInfoDataWriter_impl();
}

::DDS::OpenSplice::DataReader *
MAVLink::GPSInfoTypeSupportMetaHolder::create_datareader ()
{
    return new MAVLink::GPSInfoDataReader_impl();
}

::DDS::OpenSplice::DataReaderView *
MAVLink::GPSInfoTypeSupportMetaHolder::create_view ()
{
    return new MAVLink::GPSInfoDataReaderView_impl();
}

// DDS MAVLink::GPSInfo TypeSupport Object Body
MAVLink::GPSInfoTypeSupport::GPSInfoTypeSupport () :
        DDS::OpenSplice::TypeSupport()
{
    tsMetaHolder = new MAVLink::GPSInfoTypeSupportMetaHolder();
}
...
// DDS MAVLink::GPSInfo DataWriter_impl Object Body
MAVLink::GPSInfoDataWriter_impl::GPSInfoDataWriter_impl ()
{
...
::DDS::ReturnCode_t
MAVLink::GPSInfoDataWriter_impl::init (
...
MAVLink::GPSInfoDataWriter_impl::register_instance (
    const MAVLink::GPSInfo & instance_data) THROW_ORB_EXCEPTIONS
{
    return DDS::OpenSplice::FooDataWriter_impl::register_instance(&instance_data);
}

::DDS::InstanceHandle_t
MAVLink::GPSInfoDataWriter_impl::register_instance_w_timestamp (
...
::DDS::ReturnCode_t
MAVLink::GPSInfoDataWriter_impl::unregister_instance (
    const MAVLink::GPSInfo & instance_data,
...
::DDS::ReturnCode_t
MAVLink::GPSInfoDataWriter_impl::unregister_instance_w_timestamp (
    const GPSInfo & instance_data,
...
::DDS::ReturnCode_t
MAVLink::GPSInfoDataWriter_impl::write (
    const MAVLink::GPSInfo & instance_data,
    ::DDS::InstanceHandle_t handle) THROW_ORB_EXCEPTIONS
{
...
::DDS::ReturnCode_t
MAVLink::GPSInfoDataWriter_impl::write_w_timestamp (
    const GPSInfo & instance_data,
    ::DDS::InstanceHandle_t handle,
    const ::DDS::Time_t & source_timestamp) THROW_ORB_EXCEPTIONS
{
...
::DDS::ReturnCode_t
MAVLink::GPSInfoDataWriter_impl::dispose (
    const MAVLink::GPSInfo & instance_data,
    ::DDS::InstanceHandle_t handle) THROW_ORB_EXCEPTIONS
{
...
::DDS::ReturnCode_t
MAVLink::GPSInfoDataWriter_impl::dispose_w_timestamp (
    const GPSInfo & instance_data,
    ::DDS::InstanceHandle_t handle,
    const ::DDS::Time_t & source_timestamp) THROW_ORB_EXCEPTIONS
{
...
::DDS::ReturnCode_t
MAVLink::GPSInfoDataWriter_impl::writedispose (
    const MAVLink::GPSInfo & instance_data,
    ::DDS::InstanceHandle_t handle) THROW_ORB_EXCEPTIONS
{
...
::DDS::ReturnCode_t
MAVLink::GPSInfoDataWriter_impl::writedispose_w_timestamp (
    const GPSInfo & instance_data,
    ::DDS::InstanceHandle_t handle,
    const ::DDS::Time_t & source_timestamp) THROW_ORB_EXCEPTIONS
{
...
::DDS::ReturnCode_t
MAVLink::GPSInfoDataWriter_impl::get_key_value (
    GPSInfo & key_holder,
    ::DDS::InstanceHandle_t handle) THROW_ORB_EXCEPTIONS
{
...
::DDS::InstanceHandle_t
MAVLink::GPSInfoDataWriter_impl::lookup_instance (
    const MAVLink::GPSInfo & instance_data) THROW_ORB_EXCEPTIONS
{
    return DDS::OpenSplice::FooDataWriter_impl::lookup_instance(&instance_data);
}

// DDS MAVLink::GPSInfo DataReader_impl Object Body
MAVLink::GPSInfoDataReader_impl::GPSInfoDataReader_impl ()
{
    // Parent constructor takes care of everything.
}
...
DDS::ReturnCode_t
MAVLink::GPSInfoDataReader_impl::init (
...
::DDS::ReturnCode_t
MAVLink::GPSInfoDataReader_impl::read (
    MAVLink::GPSInfoSeq & received_data,
...
::DDS::ReturnCode_t
MAVLink::GPSInfoDataReader_impl::take (
    MAVLink::GPSInfoSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::SampleStateMask sample_states,
...
::DDS::ReturnCode_t
MAVLink::GPSInfoDataReader_impl::read_w_condition (
    MAVLink::GPSInfoSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
...
::DDS::ReturnCode_t
MAVLink::GPSInfoDataReader_impl::take_w_condition (
    MAVLink::GPSInfoSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::ReadCondition_ptr a_condition) THROW_ORB_EXCEPTIONS
...
::DDS::ReturnCode_t
MAVLink::GPSInfoDataReader_impl::read_next_sample (
    MAVLink::GPSInfo & received_data,
...
::DDS::ReturnCode_t
MAVLink::GPSInfoDataReader_impl::take_next_sample (
    MAVLink::GPSInfo & received_data,
    ::DDS::SampleInfo & sample_info) THROW_ORB_EXCEPTIONS
{
...
::DDS::ReturnCode_t
MAVLink::GPSInfoDataReader_impl::read_instance (
    MAVLink::GPSInfoSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
...
::DDS::ReturnCode_t
MAVLink::GPSInfoDataReader_impl::take_instance (
    MAVLink::GPSInfoSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
::DDS::ReturnCode_t
MAVLink::GPSInfoDataReader_impl::read_next_instance (
    MAVLink::GPSInfoSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
::DDS::ReturnCode_t
MAVLink::GPSInfoDataReader_impl::take_next_instance (
    MAVLink::GPSInfoSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
::DDS::ReturnCode_t
MAVLink::GPSInfoDataReader_impl::read_next_instance_w_condition (
    MAVLink::GPSInfoSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
::DDS::ReturnCode_t
MAVLink::GPSInfoDataReader_impl::take_next_instance_w_condition (
    MAVLink::GPSInfoSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
::DDS::ReturnCode_t
MAVLink::GPSInfoDataReader_impl::return_loan (
    MAVLink::GPSInfoSeq & received_data,
        ...
        if ( received_data.length() > 0 ) {
            if (received_data.length() == info_seq.length() &&
                ...
                if (!received_data.release()) {
                    ...
                    if ( result == ::DDS::RETCODE_OK ) {
                        if ( !received_data.release() ) {
                            MAVLink::GPSInfoSeq::freebuf( received_data.get_buffer(false) );
...
::DDS::ReturnCode_t
MAVLink::GPSInfoDataReader_impl::get_key_value (
    MAVLink::GPSInfo & key_holder,
    ::DDS::InstanceHandle_t handle) THROW_ORB_EXCEPTIONS
{
...
::DDS::InstanceHandle_t
MAVLink::GPSInfoDataReader_impl::lookup_instance (
    const MAVLink::GPSInfo & instance) THROW_ORB_EXCEPTIONS
{
    return DDS::OpenSplice::FooDataReader_impl::lookup_instance(&instance);
}

::DDS::ReturnCode_t
MAVLink::GPSInfoDataReader_impl::check_preconditions (
    MAVLink::GPSInfoSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples)
{
...
void *
MAVLink::GPSInfoDataReader_impl::dataSeqAlloc (
    void * received_data,
    DDS::ULong len)
{
    MAVLink::GPSInfoSeq *data_seq = reinterpret_cast<MAVLink::GPSInfoSeq *>(received_data);
    data_seq->replace(len, len, data_seq->allocbuf(len), false);
    return data_seq->get_buffer();
}

void *
MAVLink::GPSInfoDataReader_impl::dataSeqGetBuffer (
    void * received_data,
    DDS::ULong index)
{
	MAVLink::GPSInfoSeq *data_seq = reinterpret_cast<MAVLink::GPSInfoSeq *>(received_data);
...
void
MAVLink::GPSInfoDataReader_impl::dataSeqLength (
    void * received_data,
    DDS::ULong len)
{
    MAVLink::GPSInfoSeq *data_seq = reinterpret_cast<MAVLink::GPSInfoSeq *>(received_data);
...
void
MAVLink::GPSInfoDataReader_impl::dataSeqCopyOut (
    const void * from,
    void * to)
{
    MAVLink::GPSInfo *data = reinterpret_cast<MAVLink::GPSInfo *>(to);
    __MAVLink_GPSInfo__copyOut(from, data);
}

void
MAVLink::GPSInfoDataReader_impl::copyDataOut (
    const void * from,
    void * to)
{
    MAVLink::GPSInfo *data = reinterpret_cast<MAVLink::GPSInfo *>(to);
...
// DDS MAVLink::GPSInfo DataReaderView_impl Object Body
MAVLink::GPSInfoDataReaderView_impl::GPSInfoDataReaderView_impl ()
{
    // Parent constructor takes care of everything.
}
...
DDS::ReturnCode_t
MAVLink::GPSInfoDataReaderView_impl::init (
    ...
    DDS::OpenSplice::cxxCopyOut copyOut)
{
    return DDS::OpenSplice::FooDataReaderView_impl::nlReq_init(
            reader, name, qos, copyIn, copyOut, MAVLink::GPSInfoDataReader_impl::dataSeqAlloc,
            MAVLink::GPSInfoDataReader_impl::dataSeqLength);
}

::DDS::ReturnCode_t
MAVLink::GPSInfoDataReaderView_impl::read (
    MAVLink::GPSInfoSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::SampleStateMask sample_states,
    ...
    ::DDS::InstanceStateMask instance_states) THROW_ORB_EXCEPTIONS
{
    ...
    status = MAVLink::GPSInfoDataReader_impl::check_preconditions(received_data, info_seq, max_samples);
    if ( status == ::DDS::RETCODE_OK ) {
...
::DDS::ReturnCode_t
MAVLink::GPSInfoDataReaderView_impl::take (
    MAVLink::GPSInfoSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::SampleStateMask sample_states,
...
::DDS::ReturnCode_t
MAVLink::GPSInfoDataReaderView_impl::read_w_condition (
    MAVLink::GPSInfoSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::ReadCondition_ptr a_condition) THROW_ORB_EXCEPTIONS
...
::DDS::ReturnCode_t
MAVLink::GPSInfoDataReaderView_impl::take_w_condition (
    MAVLink::GPSInfoSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::ReadCondition_ptr a_condition) THROW_ORB_EXCEPTIONS
...
::DDS::ReturnCode_t
MAVLink::GPSInfoDataReaderView_impl::read_next_sample (
    MAVLink::GPSInfo & received_data,
    ::DDS::SampleInfo & sample_info) THROW_ORB_EXCEPTIONS
{
...
::DDS::ReturnCode_t
MAVLink::GPSInfoDataReaderView_impl::take_next_sample (
    MAVLink::GPSInfo & received_data,
    ::DDS::SampleInfo & sample_info) THROW_ORB_EXCEPTIONS
{
...
::DDS::ReturnCode_t
MAVLink::GPSInfoDataReaderView_impl::read_instance (
    MAVLink::GPSInfoSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
::DDS::ReturnCode_t
MAVLink::GPSInfoDataReaderView_impl::take_instance (
    MAVLink::GPSInfoSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
::DDS::ReturnCode_t
MAVLink::GPSInfoDataReaderView_impl::read_next_instance (
    MAVLink::GPSInfoSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
::DDS::ReturnCode_t
MAVLink::GPSInfoDataReaderView_impl::take_next_instance (
    MAVLink::GPSInfoSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
::DDS::ReturnCode_t
MAVLink::GPSInfoDataReaderView_impl::read_next_instance_w_condition (
    MAVLink::GPSInfoSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
::DDS::ReturnCode_t
MAVLink::GPSInfoDataReaderView_impl::take_next_instance_w_condition (
    MAVLink::GPSInfoSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
::DDS::ReturnCode_t
MAVLink::GPSInfoDataReaderView_impl::return_loan (
    MAVLink::GPSInfoSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq) THROW_ORB_EXCEPTIONS
{
    ::DDS::ReturnCode_t result = ::DDS::RETCODE_OK;
...
::DDS::ReturnCode_t
MAVLink::GPSInfoDataReaderView_impl::get_key_value (
    MAVLink::GPSInfo & key_holder,
    ::DDS::InstanceHandle_t handle) THROW_ORB_EXCEPTIONS
{
...
::DDS::InstanceHandle_t
MAVLink::GPSInfoDataReaderView_impl::lookup_instance (
    const MAVLink::GPSInfo & instance) THROW_ORB_EXCEPTIONS
{
...
INSTANTIATE_TYPED_REGISTRIES(::MAVLink::GPSInfo)
