...
/*{ { CFE_MAKE_BIG16(MD_WAKEUP_MID),            CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), 0x0000 } }, */
  ...
  */
  ...
  { { CFE_MAKE_BIG16(FREQ_30_WAKEUP_MID),  CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), 0x0000 } },
    /* command ID #32 */
  { { CFE_MAKE_BIG16(FREQ_20_WAKEUP_MID),  CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), 0x0000 } },
    /* command ID #33 */
  { { CFE_MAKE_BIG16(FREQ_10_WAKEUP_MID),  CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), 0x0000 } },
    /* command ID #34 */
  { { CFE_MAKE_BIG16(FREQ_05_WAKEUP_MID),  CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), 0x0000 } },
    /* command ID #35 */
