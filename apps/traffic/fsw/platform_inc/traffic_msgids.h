...
#define ICAROUS_BANDS_TRACK_MID          0x0350 ///< Kinematic track traffic bands. message type: bands_t
#define ICAROUS_BANDS_SPEED_MID          0x0351 ///< Kinematic speed traffic bands. message type: bands_t
#define ICAROUS_BANDS_VS_MID             0x0352 ///< Kinematic vertical speed traffic bands. message type: bands_t
#define ICAROUS_BANDS_ALT_MID            0x0353 ///< Kinematic altitude speed bands. message type: bands_t
