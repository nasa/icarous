...
void SubscribeInputs(){
	CFE_SB_SubscribeLocal(ICAROUS_POSITION_MID,appdataLog.LOG_AutopilotData_Pipe,CFE_SB_DEFAULT_MSG_LIMIT);
    CFE_SB_SubscribeLocal(ICAROUS_COMMANDS_MID,appdataLog.LOG_Commands_Pipe,CFE_SB_DEFAULT_MSG_LIMIT);
	CFE_SB_SubscribeLocal(ICAROUS_FLIGHTPLAN_MID,appdataLog.LOG_Commands_Pipe,CFE_SB_DEFAULT_MSG_LIMIT);
	CFE_SB_SubscribeLocal(ICAROUS_GEOFENCE_MID,appdataLog.LOG_Commands_Pipe,CFE_SB_DEFAULT_MSG_LIMIT);
	CFE_SB_SubscribeLocal(ICAROUS_COMACK_MID,appdataLog.LOG_AutopilotData_Pipe,CFE_SB_DEFAULT_MSG_LIMIT);
	CFE_SB_SubscribeLocal(ICAROUS_STARTMISSION_MID,appdataLog.LOG_Commands_Pipe,CFE_SB_DEFAULT_MSG_LIMIT);
    CFE_SB_SubscribeLocal(ICAROUS_TRAFFIC_MID,appdataLog.LOG_AutopilotData_Pipe,CFE_SB_DEFAULT_MSG_LIMIT);
	CFE_SB_SubscribeLocal(ICAROUS_WPREACHED_MID,appdataLog.LOG_AutopilotData_Pipe,CFE_SB_DEFAULT_MSG_LIMIT);
}
