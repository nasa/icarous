...
#define SWIGTYPE_p_algorithm swig_types[0]
...
#define SWIG_init    Trajectoryplanner_Init
#define SWIG_name    "trajectoryplanner"
#define SWIG_prefix  ""
...
extern "C" {
#endif
SWIGINTERN const char *_wrap_FlightData_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2, int flags) {
  Tcl_Obj *value = 0;
  
  value = SWIG_NewInstanceObj(SWIG_as_voidptr(&FlightData), SWIGTYPE_p_class, 0 );
  if (value) {
...
SWIGINTERN const char *_wrap_FlightData_set(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2 SWIGUNUSED, int flags) {
  Tcl_Obj *value = 0;
  Tcl_Obj *name1o = 0;
  ...
  if (!value) SWIG_fail;
  {
    ...
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in variable '""FlightData""' of type '""class""'");
    }
    if (!argp) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in variable '""FlightData""' of type '""class""'");
    } else {
      FlightData = *((class *)(argp));
    }
  }
  return NULL;
fail:
...
static swig_var_info swig_variables[] = {
    { SWIG_prefix "FlightData", 0, (swig_variable_func) _wrap_FlightData_get,(swig_variable_func) _wrap_FlightData_set},
    {0,0,0,0}
};
...
static swig_type_info _swigt__p_algorithm = {"_p_algorithm", "enum algorithm *|algorithm *", 0, 0, (void*)0, 0};
...
static swig_cast_info _swigc__p_algorithm[] = {  {&_swigt__p_algorithm, 0, 0, 0},{0, 0, 0, 0}};
...
SWIGEXPORT int SWIG_init(Tcl_Interp *interp) {
  ...
  SWIG_Tcl_SetConstantObj(interp, "_ASTAR_", SWIG_From_int((int)(_ASTAR_)));
  SWIG_Tcl_SetConstantObj(interp, "_RRT_", SWIG_From_int((int)(_RRT_)));
  return TCL_OK;
}
SWIGEXPORT int Trajectoryplanner_SafeInit(Tcl_Interp *interp) {
