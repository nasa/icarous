...
void CDSSCyl::init(const double d, const double h, const double f) {
  D = d;
  H = h;
  filter = f;
 ...
 */
CDSSCyl::CDSSCyl(const double distance, const double height, const double cdfilter) {
 ...
 */
CDSSCyl CDSSCyl::make(double distance, const std::string& dStr, double height, const std::string& hStr) {
  return CDSSCyl(Units::from(dStr, distance), Units::from(hStr,height), 1.0);
}
 ...
 * @param height the minimum vertical separation height [m].
 */
CDSSCyl CDSSCyl::mk(double distance, double height) {
  return CDSSCyl(distance, height, 1.0);
}
...
CDSSCyl& CDSSCyl::operator=(const CDSSCyl& cdss) {
 ...
 * @return the distance
 */
double CDSSCyl::getDistance() const {
  return D;
}
 ...
 */
double CDSSCyl::getDistance(const std::string& ud) const {
 ...
 */
double CDSSCyl::getHeight() const {
  return H;
}
 ...
 */
double CDSSCyl::getHeight(const std::string& uh) const {
 ...
 */
double CDSSCyl::getTimeHorizon() const {
  return TimeHorizon;
}
 ...
 */
double CDSSCyl::getTimeHorizon(const std::string& ut) const {
 ...
 */
double CDSSCyl::getFilterTime() const {
  return filter;
}
 ...
 */
void CDSSCyl::setDistance(const double distance) {
  D = distance;
}
 ...
 * @param ud the explicit units of distance
 */
void CDSSCyl::setDistance(const double distance, const std::string& ud) {
 ...
 */
void CDSSCyl::setHeight(const double height) {
  H = height;
}
 ...
 */
void CDSSCyl::setHeight(const double height, const std::string& uh) {
 ...
 * time < 0 means infinite time horizon
 */
void CDSSCyl::setTimeHorizon(const double time) {
  TimeHorizon = time;
}
 ...
 * @param ut the explicit units of time
 */
void CDSSCyl::setTimeHorizon(const double time, const std::string& ut) {
 ...
 */
void CDSSCyl::setFilterTime(const double cdfilter) {
  filter = cdfilter;
}

double CDSSCyl::getFilter() const {
  return filter;
}
 ...
 */
bool CDSSCyl::lossOfSeparation(const Vect3& s) const {
  return CD3D::LoS(s,D,H);
}

bool CDSSCyl::lossOfSeparation(const Vect3& so, const Vect3& si) const {
  return CD3D::lossOfSep(so,si,D,H);
}

bool CDSSCyl::lossOfSeparation(const Vect3& so, const Vect3& si, double d, double h) {
  return CD3D::lossOfSep(so,si,d,h);
}
 ...
 */
bool CDSSCyl::conflictEver(const Vect3& so, const Velocity& vo, const Vect3& si, const Velocity& vi) const {
  return CD3D::cd3d(so.Sub(si),vo,vi,D,H,TimeHorizon);
}

bool CDSSCyl::conflict(const Vect3& s, const Velocity& vo, const Velocity& vi, double D, double H, double T) { // static
  return CD3D::cd3d(s,vo,vi,D,H,T);
}

bool CDSSCyl::conflict(const Vect3& so, const Velocity& vo, const Vect3& si, const Velocity& vi, double D, double H, double T) {
  return CD3D::cd3d(so.Sub(si),vo,vi,D,H,T);
}
 ...
 */
bool CDSSCyl::conflictBetween(const Vect3& so, const Velocity& vo, const Vect3& si, const Velocity& vi,
    const double B, const double T) const {
  return CD3D::cd3d(so.Sub(si),vo,vi,D,H,B,TimeHorizon < 0 ? T : Util::min(T,TimeHorizon));
}
 ...
 */
bool CDSSCyl::conflict(const Vect3& so, const Velocity& vo, const Vect3& si, const Velocity& vi,const double T) const {
 ...
 * @return true, if the aircraft are in conflict in the interval [0,T].
 */
bool CDSSCyl::conflict(const Vect3& so, const Velocity& vo, const Vect3& si, const Velocity& vi,
 ...
 */
bool CDSSCyl::detectionEver(const Vect3& so, const Velocity& vo, const Vect3& si, const Velocity& vi) {
  ConflictData det = CDCylinder::conflict_detection(so, vo, si, vi, D, H, 0.0, TimeHorizon);
 ...
 * in the interval [B,T].
 */
bool CDSSCyl::detectionBetween(const Vect3& so, const Velocity& vo, const Vect3& si, const Velocity& vi,
 ...
 * in the interval [0,T].
 */
bool CDSSCyl::detection(const Vect3& so, const Velocity& vo, const Vect3& si, const Velocity& vi, const double T) {
 ...
 * in the interval [0,T].
 */
bool CDSSCyl::detection(const Vect3& so, const Velocity& vo, const Vect3& si, const Velocity& vi,
 ...
 */
double CDSSCyl::conflictDuration() const {
  if (!conflict())
    return 0;
  return t_out - t_in;
}
 ...
 */
double CDSSCyl::conflictDuration(const std::string& ut) const {
 ...
 * @return
 */
double CDSSCyl::timeIntoLoS(const Vect3& s, const Vect3& vo, const Vect3& vi, double D, double H) {
 ...
 * is no conflict.
 */
double CDSSCyl::getTimeIn() const {
  if (conflict())
    return t_in;
  return PINFINITY;
}
 ...
 */
double CDSSCyl::getTimeIn(const std::string& ut) const {
 ...
 */
double CDSSCyl::getTimeOut() const {
  if (conflict())
    return t_out;
  return NINFINITY;
}
 ...
 * timeOut is infinite.
 */
double CDSSCyl::getTimeOut(const std::string& ut) const {
 ...
 */
double CDSSCyl::getCriticalTime() const {
  return tca;
}
 ...
 */
double CDSSCyl::getCriticalTime(const std::string& ut) const {
 ...
 */
double CDSSCyl::cylindricalDistanceAtCriticalTime() const {
 ...
 *
 */
Vect3 CDSSCyl::relativePositionAtCriticalTime() const {
  return stca;
}
 ...
 *
 */
double CDSSCyl::verticalDistanceAtCriticalTime() const {
 ...
 *
 */
double CDSSCyl::verticalDistanceAtCriticalTime(const std::string& ud) const {
  return Units::to(ud,verticalDistanceAtCriticalTime());
}
 ...
 */
double CDSSCyl::horizontalDistanceAtCriticalTime() const {
 ...
 * @return the horizontal distance at time of closest approach.
 */
double CDSSCyl::horizontalDistanceAtCriticalTime(const std::string& ud) const {
  return Units::to(ud,horizontalDistanceAtCriticalTime());
}



std::string CDSSCyl::toString() {
