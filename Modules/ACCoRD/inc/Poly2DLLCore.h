...
public:
	...
	static bool spherical_inside_prelim(const std::vector<LatLonAlt>& p, const LatLonAlt& ll, double BUFF) ;
	/**
	 * Main function
	...
	static bool spherical_outside_prelim(const std::vector<LatLonAlt>& p, const LatLonAlt& ll, double BUFF);
	/**
	 * Main function
	 * @param p list of points (polygon)
	 * @param ll point
