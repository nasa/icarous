...
public final class CDSIPolygon implements ErrorReporter, DetectionPolygonAcceptor {  
   ...
   * @return
   */
  public boolean conflictXYZ(Vect3 so, Velocity vo, double t0, double state_horizon, PolyPath intent, double B, double T) {
	    double t_base;
	    int start_seg;
	    double BT = 0.0;
	    double NT = 0.0;
 ...
 * @return
 */
	  public boolean conflictLL(LatLonAlt so, Velocity vo, double t0, double state_horizon, PolyPath intent, double B, double T) {
	    double t_base;
	    int start_seg;
	    double BT = 0.0;
	    double NT = 0.0;
