...
public final class GreatCircle {
	...
	public static double parse_degrees(String degMinSec) {
	  ...
	  * 
	  * @param degMinSec string representing the latitude
	  * @param lon string representing the longitude
...
//		double p1p2trk = initial_course(p1,p2);
//		double p1p2dist = angular_distance(p1,p2);
//		double p1p3dist = angular_distance(p1,p3);
//		double p1p3trk = initial_course(p1,p3);
//		if (Util.within_epsilon(p1p2trk,p1p3trk, 0.0001)) {
//			if (p1p3dist <= p1p2dist) {
//f.pln("GreatCircle.closest_point_segment within p3="+p3);			
//				// within segment
//				return p3;
//			} else {
//f.pln("GreatCircle.closest_point_segment past end p1p2dist="+p1p2dist+" p1p3dist="+p1p3dist);			
//				 // dist past end point
//				return p2;
//			}
//		} else {
//f.pln("GreatCircle.closest_point_segment behind p1p2trk="+p1p2trk+" p1p3trk="+p1p3trk);			
//			// wrong direction, must be "behind" p1
//			return p1;
//		}
