...
\DoxyCodeLine{35     larcfm::CDPolycarp geoPolyCarp;}
\DoxyCodeLine{36     larcfm::PolycarpResolution geoPolyResolution;}
\DoxyCodeLine{37     larcfm::PolycarpDetection geoPolyDetect;}
\DoxyCodeLine{38     larcfm::PolyPath geoPolyPath;}
\DoxyCodeLine{39     larcfm::CDIIPolygon geoCDIIPolygon;}
\DoxyCodeLine{40     std::list<GeofenceConflict> conflictList;}
\DoxyCodeLine{41     \textcolor{keywordtype}{bool} CollisionDetection(fence* gf,larcfm::Position* pos, larcfm::Vect2* v,\textcolor{keywordtype}{double} startTime, \textcolor{keywordtype}{double} stopTime);}
