...
void \mbox{\hyperlink{class_guidance_a95bce920021a29d2b3c9dbe94e32fa95}{Set\+Guidance\+Mode}} (const Guidance\+Mode \mbox{\hyperlink{class_guidance_a50024fbe5c70caa58cc683a98e2f3d37}{mode}}, const std\+::string plan\+ID, const int next\+WP, const bool eta)
...
{\footnotesize\ttfamily void Guidance\+::\+Set\+Guidance\+Mode (\begin{DoxyParamCaption}\item[{const Guidance\+Mode}]{mode,  }\item[{const std\+::string}]{plan\+ID,  }\item[{const int}]{next\+WP,  }\item[{const bool}]{eta }\end{DoxyParamCaption})}
