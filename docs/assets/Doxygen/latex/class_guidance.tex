...
void \mbox{\hyperlink{class_guidance_a80e367c673156c2b0dcbf74306e01d38}{Set\+Aircraft\+State}} (const \mbox{\hyperlink{classlarcfm_1_1_position}{larcfm\+::\+Position}} \&pos, const \mbox{\hyperlink{classlarcfm_1_1_velocity}{larcfm\+::\+Velocity}} \&ground\+Speed)
...
void \mbox{\hyperlink{class_guidance_a052f2143feaaca24a511cf5f7a30cdf1}{Set\+Velocity\+Commands}} (const \mbox{\hyperlink{classlarcfm_1_1_velocity}{larcfm\+::\+Velocity}} \&inputs)
...
\begin{DoxyCompactItemize}
\item 
double \mbox{\hyperlink{class_guidance_a09cde1ef1e07435eb9b51cef679e7e72}{Compute\+Off\+Set\+Position\+On\+Plan}} (\mbox{\hyperlink{classlarcfm_1_1_plan}{larcfm\+::\+Plan}} $\ast$fp, int next\+WP, double guidance\+\_\+radius, \mbox{\hyperlink{classlarcfm_1_1_position}{larcfm\+::\+Position}} \&pos)
...
\mbox{\hyperlink{classlarcfm_1_1_vect3}{larcfm\+::\+Vect3}} \mbox{\hyperlink{class_guidance_acaf0febbd3b74f90045eca72c3ac466e}{Get\+Correct\+Intersection\+Point}} (const \mbox{\hyperlink{classlarcfm_1_1_vect3}{larcfm\+::\+Vect3}} \&wpA, const \mbox{\hyperlink{classlarcfm_1_1_vect3}{larcfm\+::\+Vect3}} \&wpB, const double r)
...
double \mbox{\hyperlink{class_guidance_a6eb0f998b75786d65b6c009b99ce709c}{Get\+Approach\+Precision}} (const \mbox{\hyperlink{classlarcfm_1_1_position}{larcfm\+::\+Position}} \&\mbox{\hyperlink{arducopter_8h_a97f6f07d9b99c3e3d789183a9064a7da}{position}}, const \mbox{\hyperlink{classlarcfm_1_1_velocity}{larcfm\+::\+Velocity}} \&velocity, const \mbox{\hyperlink{classlarcfm_1_1_position}{larcfm\+::\+Position}} \&waypoint)
...
\mbox{\hyperlink{classlarcfm_1_1_plan}{larcfm\+::\+Plan}} $\ast$ \mbox{\hyperlink{class_guidance_a6a1adb5833bec5563805c903343a4a76}{Get\+Plan}} (const std\+::string \&plan\+\_\+id)
...
std\+::list$<$ \mbox{\hyperlink{classlarcfm_1_1_plan}{larcfm\+::\+Plan}} $>$ {\bfseries plan\+List}
...
\mbox{\hyperlink{classlarcfm_1_1_plan}{larcfm\+::\+Plan}} $\ast$ {\bfseries current\+Plan}
...
\mbox{\hyperlink{classlarcfm_1_1_position}{larcfm\+::\+Position}} {\bfseries current\+Pos}
...
\mbox{\hyperlink{classlarcfm_1_1_velocity}{larcfm\+::\+Velocity}} {\bfseries current\+Airspeed}
...
\mbox{\hyperlink{classlarcfm_1_1_velocity}{larcfm\+::\+Velocity}} {\bfseries current\+Ground\+Speed}
...
\mbox{\hyperlink{classlarcfm_1_1_velocity}{larcfm\+::\+Velocity}} {\bfseries output\+Cmd}
...
\mbox{\hyperlink{classlarcfm_1_1_velocity}{larcfm\+::\+Velocity}} {\bfseries wind}
...
{\footnotesize\ttfamily double Guidance\+::\+Compute\+Off\+Set\+Position\+On\+Plan (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classlarcfm_1_1_plan}{larcfm\+::\+Plan}} $\ast$}]{fp,  }\item[{int}]{next\+WP,  }\item[{double}]{guidance\+\_\+radius,  }\item[{\mbox{\hyperlink{classlarcfm_1_1_position}{larcfm\+::\+Position}} \&}]{pos }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [private]}}
...
{\footnotesize\ttfamily double Guidance\+::\+Get\+Approach\+Precision (\begin{DoxyParamCaption}\item[{const \mbox{\hyperlink{classlarcfm_1_1_position}{larcfm\+::\+Position}} \&}]{position,  }\item[{const \mbox{\hyperlink{classlarcfm_1_1_velocity}{larcfm\+::\+Velocity}} \&}]{velocity,  }\item[{const \mbox{\hyperlink{classlarcfm_1_1_position}{larcfm\+::\+Position}} \&}]{waypoint }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [private]}}
...
{\footnotesize\ttfamily \mbox{\hyperlink{classlarcfm_1_1_vect3}{larcfm\+::\+Vect3}} Guidance\+::\+Get\+Correct\+Intersection\+Point (\begin{DoxyParamCaption}\item[{const \mbox{\hyperlink{classlarcfm_1_1_vect3}{larcfm\+::\+Vect3}} \&}]{wpA,  }\item[{const \mbox{\hyperlink{classlarcfm_1_1_vect3}{larcfm\+::\+Vect3}} \&}]{wpB,  }\item[{const double}]{r }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [private]}}
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
\mbox{\hyperlink{classlarcfm_1_1_vect3}{larcfm\+::\+Vect3}} Intersection of circle with plan segment 
\end{DoxyReturn}
...
{\footnotesize\ttfamily \mbox{\hyperlink{classlarcfm_1_1_plan}{larcfm\+::\+Plan}} $\ast$ Guidance\+::\+Get\+Plan (\begin{DoxyParamCaption}\item[{const std\+::string \&}]{plan\+\_\+id }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [private]}}
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
\mbox{\hyperlink{classlarcfm_1_1_plan}{larcfm\+::\+Plan}}$\ast$ pointer to plan 
\end{DoxyReturn}
...
{\footnotesize\ttfamily void Guidance\+::\+Set\+Aircraft\+State (\begin{DoxyParamCaption}\item[{const \mbox{\hyperlink{classlarcfm_1_1_position}{larcfm\+::\+Position}} \&}]{pos,  }\item[{const \mbox{\hyperlink{classlarcfm_1_1_velocity}{larcfm\+::\+Velocity}} \&}]{ground\+Speed }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily void Guidance\+::\+Set\+Velocity\+Commands (\begin{DoxyParamCaption}\item[{const \mbox{\hyperlink{classlarcfm_1_1_velocity}{larcfm\+::\+Velocity}} \&}]{inputs }\end{DoxyParamCaption})}
