...
\DoxyCodeLine{18 }
\DoxyCodeLine{19 \textcolor{preprocessor}{\#include "{}\mbox{\hyperlink{_modules_2_core_2_guidance_2guidance_8h}{Guidance.h}}"{}}}
...
\DoxyCodeLine{33     \mbox{\hyperlink{classlarcfm_1_1_plan}{larcfm::Plan}}* \mbox{\hyperlink{class_guidance_a747324c9ea535bbdc0b0b05eb50be855}{currentPlan}};                        }
\DoxyCodeLine{34     \mbox{\hyperlink{classlarcfm_1_1_position}{larcfm::Position}} \mbox{\hyperlink{class_guidance_a50450dacd698e9da0be6b593858bcef2}{currentPos}};                      }
\DoxyCodeLine{35     \mbox{\hyperlink{classlarcfm_1_1_velocity}{larcfm::Velocity}} \mbox{\hyperlink{class_guidance_a8b993d81fec5384ad4f12944b459bfec}{currentAirspeed}};                 }
\DoxyCodeLine{36     \mbox{\hyperlink{classlarcfm_1_1_velocity}{larcfm::Velocity}} \mbox{\hyperlink{class_guidance_a118ce9bd01ef62ba59b3f8208e43e2cc}{currentGroundSpeed}};              }
\DoxyCodeLine{37     \mbox{\hyperlink{classlarcfm_1_1_velocity}{larcfm::Velocity}} \mbox{\hyperlink{class_guidance_a5524351858d155338c1e0c7cdb608980}{outputCmd}};                       }
\DoxyCodeLine{38     \mbox{\hyperlink{_modules_2_core_2_guidance_2guidance_8h_a59cb78b8a1e23b30cdbd8e61db8c8e01}{GuidanceMode}} \mbox{\hyperlink{class_guidance_a50024fbe5c70caa58cc683a98e2f3d37}{mode}};                                }
...
\DoxyCodeLine{48     \mbox{\hyperlink{classlarcfm_1_1_velocity}{larcfm::Velocity}} \mbox{\hyperlink{class_guidance_a1942a98a0e540bac5732463566562098}{wind}};                            }
\DoxyCodeLine{49     }
...
\DoxyCodeLine{51 }
\DoxyCodeLine{61     \textcolor{keywordtype}{double} \mbox{\hyperlink{class_guidance_a09cde1ef1e07435eb9b51cef679e7e72}{ComputeOffSetPositionOnPlan}}(\mbox{\hyperlink{classlarcfm_1_1_plan}{larcfm::Plan}}* fp,\textcolor{keywordtype}{int} nextWP,\textcolor{keywordtype}{double} guidance\_radius,\mbox{\hyperlink{classlarcfm_1_1_position}{larcfm::Position}} \&pos);}
\DoxyCodeLine{62 }
\DoxyCodeLine{72     \mbox{\hyperlink{classlarcfm_1_1_vect3}{larcfm::Vect3}} \mbox{\hyperlink{class_guidance_acaf0febbd3b74f90045eca72c3ac466e}{GetCorrectIntersectionPoint}}(\textcolor{keyword}{const} \mbox{\hyperlink{classlarcfm_1_1_vect3}{larcfm::Vect3}} \&wpA,\textcolor{keyword}{const} \mbox{\hyperlink{classlarcfm_1_1_vect3}{larcfm::Vect3}} \&wpB,\textcolor{keyword}{const} \textcolor{keywordtype}{double} r);}
\DoxyCodeLine{73 }
...
\DoxyCodeLine{107 }
\DoxyCodeLine{116     \textcolor{keywordtype}{double} \mbox{\hyperlink{class_guidance_a6eb0f998b75786d65b6c009b99ce709c}{GetApproachPrecision}}(\textcolor{keyword}{const} \mbox{\hyperlink{classlarcfm_1_1_position}{larcfm::Position}} \&\mbox{\hyperlink{arducopter_8h_a97f6f07d9b99c3e3d789183a9064a7da}{position}},\textcolor{keyword}{const} \mbox{\hyperlink{classlarcfm_1_1_velocity}{larcfm::Velocity}} \&velocity, \textcolor{keyword}{const} \mbox{\hyperlink{classlarcfm_1_1_position}{larcfm::Position}} \&waypoint);}
\DoxyCodeLine{117 }
\DoxyCodeLine{124     \mbox{\hyperlink{classlarcfm_1_1_plan}{larcfm::Plan}}* \mbox{\hyperlink{class_guidance_a6a1adb5833bec5563805c903343a4a76}{GetPlan}}(\textcolor{keyword}{const} std::string \&plan\_id);}
\DoxyCodeLine{125 }
...
\DoxyCodeLine{168 }
\DoxyCodeLine{175     \textcolor{keywordtype}{void} \mbox{\hyperlink{class_guidance_a80e367c673156c2b0dcbf74306e01d38}{SetAircraftState}}(\textcolor{keyword}{const} \mbox{\hyperlink{classlarcfm_1_1_position}{larcfm::Position}} \&pos,\textcolor{keyword}{const} \mbox{\hyperlink{classlarcfm_1_1_velocity}{larcfm::Velocity}} \&groundSpeed);}
\DoxyCodeLine{176 }
...
\DoxyCodeLine{204 }
\DoxyCodeLine{213     \textcolor{keywordtype}{void} \mbox{\hyperlink{class_guidance_a95bce920021a29d2b3c9dbe94e32fa95}{SetGuidanceMode}}(\textcolor{keyword}{const} \mbox{\hyperlink{_modules_2_core_2_guidance_2guidance_8h_a59cb78b8a1e23b30cdbd8e61db8c8e01}{GuidanceMode}} \mbox{\hyperlink{class_guidance_a50024fbe5c70caa58cc683a98e2f3d37}{mode}},\textcolor{keyword}{const} std::string planID,\textcolor{keyword}{const} \textcolor{keywordtype}{int} nextWP,\textcolor{keyword}{const} \textcolor{keywordtype}{bool} eta);}
\DoxyCodeLine{214 }
...
\DoxyCodeLine{244 }
\DoxyCodeLine{250     \textcolor{keywordtype}{void} \mbox{\hyperlink{class_guidance_a052f2143feaaca24a511cf5f7a30cdf1}{SetVelocityCommands}}(\textcolor{keyword}{const} \mbox{\hyperlink{classlarcfm_1_1_velocity}{larcfm::Velocity}} \&inputs);}
\DoxyCodeLine{251 }
