...
\DoxyCodeLine{107      \mbox{\hyperlink{class_event_management}{EventManagement}}():activeEventHandlers(\mbox{\hyperlink{class_event_management_a3750ccbf4466f7d689bade8a06909096}{handlerComp}})\{\};}
...
\DoxyCodeLine{140 }
\DoxyCodeLine{142      \mbox{\hyperlink{struct_handler_comp}{HandlerComp<T>}} \mbox{\hyperlink{class_event_management_a3750ccbf4466f7d689bade8a06909096}{handlerComp}};}
...
\DoxyCodeLine{221            handler-\/>priority = handler-\/>defaultPriority;}
\DoxyCodeLine{222            activeEventHandlers.pop();}
\DoxyCodeLine{223         \}}
\DoxyCodeLine{224     \}\textcolor{keywordflow}{else}\{}
\DoxyCodeLine{225         val = handler-\/>RunEvent(state);}
\DoxyCodeLine{226     \}}
\DoxyCodeLine{227 }
\DoxyCodeLine{229     \textcolor{keywordflow}{if} (val) \{}
\DoxyCodeLine{230         handler-\/>priority = handler-\/>defaultPriority;}
\DoxyCodeLine{231         activeEventHandlers.pop();}
\DoxyCodeLine{232     \}}
\DoxyCodeLine{233 }
\DoxyCodeLine{235     \textcolor{keywordflow}{while} (handler-\/>children.size() > 0)\{}
\DoxyCodeLine{236         activeEventHandlers.push(handler-\/>children.back());}
\DoxyCodeLine{237         handler-\/>children.pop\_back();}
\DoxyCodeLine{238     \}}
\DoxyCodeLine{239 \}}
\DoxyCodeLine{240 }
\DoxyCodeLine{241 \textcolor{keyword}{template}<\textcolor{keyword}{class} T>}
\DoxyCodeLine{242 \textcolor{keywordtype}{void} \mbox{\hyperlink{class_event_management_a96286032040430816ae68d68b1235abb}{EventManagement<T>::Run}}(T* state)\{}
\DoxyCodeLine{243     RunEventMonitors(state);}
\DoxyCodeLine{244     RunEventHandlers(state);}
\DoxyCodeLine{245 \}}
\DoxyCodeLine{246 }
