...
bool MAVLinkMessages_t::GetParamSet(mavlink_param_set_t& msg){
 ...
 void MAVLinkMessages_t::GetGlobalPositionInt(double &time_gps,double& lat, double& lon, double& abs_alt, double& rel_alt,
		  	  	  	  	  	  	  	  	  double& vx, double& vy, double& vz){
	 pthread_mutex_lock(&lock);
	 time_gps   = (double) globalPositionInt.time_boot_ms/1E3;
